...
Bivio::Test->unit([
	...
	from_local_literal => [
	    [undef] => [undef, undef],
	    ['2378497 9'] => ['2378497 25209'],
	    ['-9'] => [undef, Bivio::TypeError->DATE_TIME],
	    ['Feb 29 0:0:0 MST 1972'] => ['2441377 25200'],
	    ['Feb 29 13:13:13 XXX 2000'] => ['2451604 72793'],
	    ['1972/2/29 0:0:0'] => ['2441377 25200'],
	    ['2000/2/29 13:13:13'] => ['2451604 72793'],
	],
	to_string => [
