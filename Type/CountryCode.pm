...
__PACKAGE__->compile([
    ...
    GY => [91, 'Guyana'],
    HT => [92, 'Haiti'],
    HM => [93, 'Heard and McDonald Islands'],
    HN => [94, 'Honduras'],
    HK => [95, 'Hong Kong'],
    HU => [96, 'Hungary'],
    IS => [97, 'Iceland'],
    ...
    RE => [174, "Re'union"],
    RO => [175, 'Romania'],
    RU => [176, 'Russian Federation'],
    RW => [177, 'Rwanda'],
    SH => [178, 'Saint Helena'],
    KN => [179, 'Saint Kitts and Nevis'],
    LC => [180, 'Saint Lucia'],
    PM  => [181, 'Saint Pierre and Miquelon'],
    ...
    TK => [210, 'Tokelau'],
    TO => [211, 'Tonga'],
    TT => [212, 'Trinidad and Tobago'],
    TN => [213, 'Tunisia'],
    TR => [214, 'Turkey'],
    TM => [215, 'Turkmenistan'],
    TC => [216, 'Turks and Caicos Islands'],
    TV => [217, 'Tuvalu'],
    UG => [218, 'Uganda'],
    UA => [219, 'Ukraine'],
    AE => [220, 'United Arab Emirates'],
    GB => [221, 'United Kingdom'],
    US => [222, 'United States'],
    UM => [223, 'United States Minor Outlying Islands'],
    UY => [224, 'Uruguay'],
    UZ => [225, 'Uzbekistan'],
    VU => [226, 'Vanuatu'],
    ...
    JE => [248, 'Jersey'],
    PS => [249, 'Palestine'],
    BL => [250, 'Saint Barthelemy'],
    MF => [251, 'Saint Martin (French Part)'],
