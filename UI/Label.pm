...
#TODO: Should these be dynamically looked up?
    ...
    CLUB_ADMIN_SUBSCRIPTIONS => 'Premium Subscriptions',
    CLUB_ADMIN_PAYMENTS => 'Premium Payments',
...
Value',
    ...
    EC_CARD_NUMBER => 'Credit Card Number',
    EC_CARD_EXP => 'Card Expiration Date',
    EC_CARD_TYPE => 'Type of Credit Card',
    EC_CARD_NAME => 'Name on Card',
    EC_CARD_ZIP => 'Card Owner\'s Zip Code',
    EC_PAYMENT_METHOD => 'Payment Method',
    EC_PAYMENT_REMARK => 'Payment Remark',
]);
