...
# $Id$
package Bivio::UI::PDF::Form::F1065::Y1999::Formf1065;
use strict;
$Bivio::UI::PDF::Form::F1065::Y1999::Formf1065::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);

=head1 NAME

Bivio::UI::PDF::Form::F1065::Y1999::Formf1065 - 

=head1 SYNOPSIS

    use Bivio::UI::PDF::Form::F1065::Y1999::Formf1065;
    Bivio::UI::PDF::Form::F1065::Y1999::Formf1065->new();
...
@Bivio::UI::PDF::Form::F1065::Y1999::Formf1065::ISA = ('Bivio::UI::PDF::Form::Form');

=head1 DESCRIPTION

C<Bivio::UI::PDF::Form::F1065::Y1999::Formf1065>
...
=head2 static new() : Bivio::UI::PDF::Form::F1065::Y1999::Formf1065
