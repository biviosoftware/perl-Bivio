...
# $Id$
package Bivio::UI::PDF::Form::F1065sk1::Y2000::XlatorSet;
use strict;
$Bivio::UI::PDF::Form::F1065sk1::Y2000::XlatorSet::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);

=head1 NAME

Bivio::UI::PDF::Form::F1065sk1::Y2000::XlatorSet - the XlatorSet for
F1065sk1::Y2000.

=head1 SYNOPSIS

    use Bivio::UI::PDF::Form::F1065sk1::Y2000::XlatorSet;
    Bivio::UI::PDF::Form::F1065sk1::Y2000::XlatorSet->new();
...
@Bivio::UI::PDF::Form::F1065sk1::Y2000::XlatorSet::ISA
	= ('Bivio::UI::PDF::Form::F1065sk1::XlatorSet');

=head1 DESCRIPTION

C<Bivio::UI::PDF::Form::F1065sk1::Y2000::XlatorSet>
...
=head2 static new() : Bivio::UI::PDF::Form::F1065sk1::Y2000::XlatorSet
