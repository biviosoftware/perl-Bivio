...
# $Id$
package Bivio::UI::HTML::Widget::AbstractControl;
use strict;
$Bivio::UI::HTML::Widget::AbstractControl::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);
$_ = $Bivio::UI::HTML::Widget::AbstractControl::VERSION;

=head1 NAME

Bivio::UI::HTML::Widget::AbstractControl - controls widget rendering with a control
...
@Bivio::UI::HTML::Widget::AbstractControl::ISA = ('Bivio::UI::HTML::Widget');

=head1 DESCRIPTION

C<Bivio::UI::HTML::Widget::AbstractControl> calls C<render> only if
...
=head2 static new() : Bivio::UI::HTML::Widget::AbstractControl
