...
Our 1999 tax software is complete.  Since this is our first year
generating tax forms, all forms are labeled as DRAFT.  Before
submitting the forms generated by bivio to the IRS, please contact
EOF
			$self->link_support(),
			<<'EOF',
.
Our support team will verify the forms are being generated correctly.
Once verified, we will remove the DRAFT label from your club's returns.
EOF
		    ),
		    'tax_disclaimer',
		),
