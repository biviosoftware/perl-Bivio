...
# $Id$
package Bivio::Agent::TaskIdDelegate;
use strict;
$Bivio::Agent::TaskIdDelegate::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);
$_ = $Bivio::Agent::TaskIdDelegate::VERSION;

=head1 NAME

Bivio::Agent::TaskIdDelegate - task declaration for bivio clubs

=head1 SYNOPSIS

    use Bivio::Agent::TaskIdDelegate;

=cut

use Bivio::UNIVERSAL;
@Bivio::Agent::TaskIdDelegate::ISA = ('Bivio::UNIVERSAL');

=head1 DESCRIPTION

C<Bivio::Agent::TaskIdDelegate> task declaration for bivio clubs
