...
# $Id$
package Bivio::Agent::HTTP::CookieDelegate;
use strict;
$Bivio::Agent::HTTP::CookieDelegate::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);
$_ = $Bivio::Agent::HTTP::CookieDelegate::VERSION;

=head1 NAME

Bivio::Agent::HTTP::CookieDelegate - bivio cookie delegate

=head1 SYNOPSIS

    use Bivio::Agent::HTTP::CookieDelegate;
...
@Bivio::Agent::HTTP::CookieDelegate::ISA = ('Bivio::Collection::Attributes');

=head1 DESCRIPTION

C<Bivio::Agent::HTTP::CookieDelegate> manages the cookie in the HTTP header.
...
=head2 static new(Bivio::Agent::Request req, Apache::Request r) : Bivio::Agent::HTTP::CookieDelegate

Creates and parses the cookie.
