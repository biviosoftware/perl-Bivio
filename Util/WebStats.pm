...
sub USAGE {
    return <<'EOF';
usage: b WebStats [options] command [args..]
commands
...
#TODO: create report for each facade
	...
	->file_name('WebStats/data', $self->req));
...
LogFile="$file_command | bivio WebStats format_access_log_stream |"
DirData="$data_dir"
EOF
