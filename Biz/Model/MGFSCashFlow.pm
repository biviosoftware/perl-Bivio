...
sub internal_initialize {
	...
	columns => {
	    ...
	    dep_and_amortization => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    deferred_inc_taxes => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    operating_losses => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    extraordinary_losses => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    other_noncash_items => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    decrease_receivables => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    decrease_inventories => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    decrease_other_current_assets => ['Bivio::Data::MGFS::Amount',
		    'NONE'],
	    increase_payables => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    increase_other_current_liab => ['Bivio::Data::MGFS::Amount',
		    'NONE'],
	    cash_cont_op => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    cash_discont_op => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    cash_op_activities => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    sale_ppe => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    sale_short_term_invest => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    purchase_ppe => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    purchase_short_term_invest => ['Bivio::Data::MGFS::Amount',
		    'NONE'],
	    other_investing_changes => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    cash_from_investing_activities => ['Bivio::Data::MGFS::Amount',
		    'NONE'],
	    issuance_debt => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    issuance_capital_stock => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    repayment_long_term_debt => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    repurchase_capital_stock => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    payment_cash_div => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    other_financing_charges => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    ...
	    change_cash_and_equivalents => ['Bivio::Data::MGFS::Amount',
		    'NONE'],
	    cash_beginning_period => ['Bivio::Data::MGFS::Amount', 'NONE'],
	},
    };
}
