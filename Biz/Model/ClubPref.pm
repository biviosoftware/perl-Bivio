...
package Bivio::Biz::Model::ClubPref;
use strict;
$Bivio::Biz::Model::ClubPref::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);

=head1 NAME

Bivio::Biz::Model::ClubPref - interface to club_pref_t SQL table

=head1 SYNOPSIS

    use Bivio::Biz::Model::ClubPref;
    Bivio::Biz::Model::ClubPref->new($req);
...
@Bivio::Biz::Model::ClubPref::ISA = qw(Bivio::Biz::PropertyModel);

=head1 DESCRIPTION

C<Bivio::Biz::Model::ClubPref> is the create, read, update,
