...
sub internal_initialize {
	...
	columns => {
	    ...
	    cash_and_equivalents => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    receivables => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    inventories => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    other_current_assets => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    gross_fixed_assets => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    current_assets => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    accum_dep_and_depletion => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    fixed_assets => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    intangibles => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    other_noncurrent_assets => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    noncurrent_assets => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    assets => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    inventory_valuation_method => [
		    'Bivio::Data::MGFS::InventoryValuationMethod', 'NOT_NULL'],
	    accounts_payable => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    short_term_debt => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    other_current_liab => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    current_liab => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    long_term_debt => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    deferred_inc_taxes => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    other_noncurrent_assets => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    int_minority => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    noncurrent_liab => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    liab => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    preferred_stock_equity => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    common_stock_equity => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    retained_earnings => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    equity => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    liab_and_stock_equity => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    cash_flow => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    working_capital => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    free_cash_flow => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    free_cash_flow_per_share => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    invested_capital => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    common_shares_outstanding => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    preferred_shares => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    ordinary_shares => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    shares_outstanding_cco => ['Bivio::Data::MGFS::Amount', 'NONE'],
	    treasury_shares => ['Bivio::Data::MGFS::Amount', 'NONE'],
        },
    };
}
