...
# $Id$
package Bivio::Biz::Model::CSIStockQuote;
use strict;
$Bivio::Biz::Model::CSIStockQuote::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);
$_ = $Bivio::Biz::Model::CSIStockQuote::VERSION;

=head1 NAME

Bivio::Biz::Model::CSIStockQuote - provide daily quotes formats

=head1 SYNOPSIS

    use Bivio::Biz::Model::CSIStockQuote;
    Bivio::Biz::Model::CSIStockQuote->new();
...
@Bivio::Biz::Model::CSIStockQuote::ISA = ('Bivio::Biz::Model::CSIBase');

=head1 DESCRIPTION

C<Bivio::Biz::Model::CSIStockQuote>
...
sub _initialize {
    Bivio::Biz::Model::CSIBase->internal_register_handler($_PACKAGE,
            ...
            Bivio::Data::CSI::RecordType::HISTORICAL_STOCK_PRICE());
    return;
}
