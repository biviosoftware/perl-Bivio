...
# $Id$
package Bivio::Biz::Model::MiscExpenseList;
use strict;
$Bivio::Biz::Model::MiscExpenseList::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);

=head1 NAME

Bivio::Biz::Model::MiscExpenseList - lists portfolio income entries

=head1 SYNOPSIS

    use Bivio::Biz::Model::MiscExpenseList;
    Bivio::Biz::Model::MiscExpenseList->new();
...
@Bivio::Biz::Model::MiscExpenseList::ISA = ('Bivio::Biz::ListModel');

=head1 DESCRIPTION

C<Bivio::Biz::Model::MiscExpenseList> lists portfolio expense entries
