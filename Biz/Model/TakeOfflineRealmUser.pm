...
# $Id$
package Bivio::Biz::Model::TakeOfflineRealmUser;
use strict;
$Bivio::Biz::Model::TakeOfflineRealmUser::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);
$_ = $Bivio::Biz::Model::TakeOfflineRealmUser::VERSION;

=head1 NAME

Bivio::Biz::Model::TakeOfflineRealmUser - Take self or other member offline

=head1 SYNOPSIS

    use Bivio::Biz::Model::TakeOfflineRealmUser;
...
@Bivio::Biz::Model::TakeOfflineRealmUser::ISA = ('Bivio::Biz::FormModel');

=head1 DESCRIPTION

C<Bivio::Biz::Model::TakeOfflineRealmUser> Takes a member offline relative to a
...
sub execute_ok {
    ...
    $req->client_redirect(
	    Bivio::Agent::TaskId::CLUB_ADMIN_SELF_DISSOCIATE_DONE())
