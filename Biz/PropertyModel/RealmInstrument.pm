...
package Bivio::Biz::PropertyModel::RealmInstrument;
use strict;
$Bivio::Biz::PropertyModel::RealmInstrument::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);

=head1 NAME

Bivio::Biz::PropertyModel::RealmInstrument - interface to realm_instrument_t SQL table
...
@Bivio::Biz::PropertyModel::RealmInstrument::ISA = qw(Bivio::Biz::PropertyModel);

=head1 DESCRIPTION

C<Bivio::Biz::PropertyModel::RealmInstrument> is the create, read, update,
