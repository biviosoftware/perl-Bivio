...
Bivio::Biz::PropertyModel::ClubUser - interface to club_user_t SQL table
...
C<Bivio::Biz::PropertyModel::ClubUser> is the create, read, update,
...
sub internal_initialize {
    return Bivio::SQL::Support->new('club_user_t', {
