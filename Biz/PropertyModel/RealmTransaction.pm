...
package Bivio::Biz::PropertyModel::RealmTransaction;
use strict;
$Bivio::Biz::PropertyModel::RealmTransaction::VERSION = sprintf('%d.%02d', q$Revision$ =~ /\d+/g);

=head1 NAME

Bivio::Biz::PropertyModel::RealmTransaction - interface to realm_transaction_t SQL table

=head1 SYNOPSIS

    use Bivio::Biz::PropertyModel::RealmTransaction;
    Bivio::Biz::PropertyModel::RealmTransaction->new($req);
...
@Bivio::Biz::PropertyModel::RealmTransaction::ISA = qw(Bivio::Biz::PropertyModel);

=head1 DESCRIPTION

C<Bivio::Biz::PropertyModel::RealmTransaction> is the create, read, update,
